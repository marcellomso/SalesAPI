...
{
    public class ConfigSqlServer : ServicoBase, IConfigBancoDados
    {
        public ConfigSqlServer(
            IUnitOfWork uow) : base(uow) { }

        public int? AlterarConfiguracao(ConfiguracaoCommand command)
        {
            ...
            return ECodigoRetorno.OperacaoOK.GetHashCode();
        }
